...
import com.ys.slackclone.chatcore.extensions.toStreamChannel
import com.ys.slackclone.common.R
import com.ys.slackclone.commonui.reusable.SlackDragComposableView
...
import com.ys.slackclone.uidashboard.compose.Screen.Search
import com.ys.slackclone.uidashboard.compose.Screen.You
import com.ys.slackclone.uidashboard.home.DirectMessagesUI
import com.ys.slackclone.uidashboard.home.HomeScreenUI
import com.ys.slackclone.uidashboard.home.MentionsReactionsUI
import com.ys.slackclone.uidashboard.home.SearchMessagesUI
import com.ys.slackclone.uidashboard.home.UserProfileUI
						...
						composable(Home.route) {
							HomeScreenUI(
								...
								onCreateChannelRequest = {
									composeNavigator.navigate(CreateChannelsScreen.name)
								}
							)
						}
						composable(DMs.route) {
							DirectMessagesUI(onItemClick = onItemClick)
						}
						composable(Mentions.route) {
							MentionsReactionsUI()
						}
						composable(Search.route) {
							SearchMessagesUI()
						}
						composable(You.route) {
							UserProfileUI()
						}
					}
				}
...
sealed class Screen(val route: String, val image: ImageVector, @StringRes val resourceId: Int) {
	...
	object DMs : Screen("DMs", Icons.Filled.Menu, R.string.dms)
	object Mentions :
		Screen("Mentions", Icons.Filled.Email, R.string.mentions)

	object Search :
		Screen("Search", Icons.Filled.Search, R.string.search)

	object You : Screen("You", Icons.Default.Face, R.string.you)
}
...
private fun RowScope.BottomNavItem(
	...
	BottomNavigationItem(
		...
		icon = { Icon(imageVector = screen.image, contentDescription = null) },
		label = {
			Text(
