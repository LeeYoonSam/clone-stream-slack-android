...
import com.ys.slackclone.common.extensions.calendar
import com.ys.slackclone.common.extensions.formattedTime
...
import com.ys.slackclone.uichat.chatthread.composables.reactions.SlackMessageReactionItem
...
fun ChatMessage(
    ...
    ListItem(
        ...
        text = {
            ChatUserDateTime(messageItemState = messageItemState)
        }
    )
}
    ...
    if (message.deletedAt == null) {
        ...
        reactionCounts
            ...
            ?.map { type ->
                ...
                val reactionIcon = iconFactory.createReactionIcon(type = type)
...
private fun ChatUserDateTime(messageItemState: MessageItemState) {
    Row(verticalAlignment = Alignment.CenterVertically) {
       Text(
        ...
        Text(
            text = messageItemState.message.createdAt?.time?.calendar()?.formattedTime() ?: "",
